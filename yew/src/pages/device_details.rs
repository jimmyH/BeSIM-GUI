...
pub fn device_details_page(props: &DeviceDetailsProps) -> Html {
    ...
    html! {
        <div class="card stack">
            <div><span class="label">{"WiFi Signal: "}</span>{format_value(&device.wifisignal)}</div>
            <div><span class="label">{"Version: "}</span>{format_value(&device.version)}</div>
            <div><span class="label">{"IP: "}</span>{format!("{}:{}", addr, port)}</div>
            <div><span class="label">{"Last Seen: "}</span>{format_last_seen(&device.lastseen)}</div>
            <div><span class="label">{"OpenTherm:"}</span></div>
            <div><span class="label">{"Boiler On: "}</span>{format_value(&device.boilerOn)}</div>
            <div><span class="label">{"DHW On: "}</span>{format_value(&device.dhwMode)}</div>
            <div><span class="label">{"tFLO: "}</span>{format_value(&device.tFLO)}</div>
            <div><span class="label">{"tdH: "}</span>{format_value(&device.tdH)}</div>
            <div><span class="label">{"tESt: "}</span>{format_value(&device.tESt)}</div>
